...
for (mut in pd_mutations) {
  ...
  mut_binned_prev_plot <- data_binned_year_plot(prev_data_mut_bin,
                                                ...
                                                prev_legend = "right")
  save_figs(file.path(manuscript_dir, supplement_dir, paste0("SFigX_", mut, "_africa_map_prev_binned_years")), mut_binned_prev_plot)
  ...
  mut_per_years_prev_plot <- data_per_year_plot(
    ...
    x_axis_break = 25,
    facet_n_row = 6)
  save_figs(file.path(manuscript_dir, supplement_dir, paste0("SFigX_", mut, "_africa_map_prev_per_years")), mut_per_years_prev_plot)
